...
export default function Home() {
  return (
    <div className="min-h-screen bg-slate-950 text-white font-poppins">
      ...
      {/* Hero Section */}
      <section className="relative flex items-center justify-center text-center px-6 py-24 bg-gradient-to-br from-blue-950 via-teal-900 to-indigo-900 bg-center">
